IMPLEMENTATIONS = {
    ...
    "quic_clients": [
        ...
        #{
        #    "name": "picoquic",
        #    "clpars_qns": "-L -a hq-27 -b /logs/clientpico_qns.log 193.167.100.100 4433 0:/$BYTESREQ;",
        #    "clpars_min": "-L -a hq-27 -b /logs/clientpico_mn.log 10.0.0.251 4433 0:/$BYTESREQ;",
        #    "clcommit": ""
        #}
    ],
    "tcp_servers": [
